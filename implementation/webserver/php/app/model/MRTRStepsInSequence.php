...
/**
 * Model of table-row of relative table of steps in a sequence. Stores single step.
 */
class MRTRStepsInSequence extends MModel {
    /**
     * @var $id
     ...
     */
    public function store(int $seqId = 0, int $index = 0) : bool {
